...
class ObjPainter(AbstractPainter):
    ...
    def draw_infra_link(self, context, vex, index, **item): pass
    ...
    def draw_infra_airport(self, context, vex, index, own, **item):
        ...
        context.set_source_rgba(1, 1, 1)
        context.move_to(xo - 0.32 * zoom, yo + 0.16 * zoom)
        context.line_to(xo + 0.32 * zoom, yo + 0.16 * zoom)
        context.line_to(xo + 0.32 * zoom, yo - 0.16 * zoom)
        context.line_to(xo - 0.32 * zoom, yo - 0.16 * zoom)
        context.line_to(xo - 0.32 * zoom, yo + 0.16 * zoom)
        context.fill()
        ...
        context.set_source_rgba(0, 0, 0)
        context.move_to(xo - 0.29 * zoom, yo + 0.13 * zoom)
        context.line_to(xo + 0.29 * zoom, yo + 0.13 * zoom)
        context.line_to(xo + 0.29 * zoom, yo - 0.13 * zoom)
        context.line_to(xo - 0.29 * zoom, yo - 0.13 * zoom)
        context.line_to(xo - 0.29 * zoom, yo + 0.13 * zoom)
        context.fill()
        ...
        context.set_source_rgba(*color)
        context.move_to(xo - 0.26 * zoom, yo + 0.1 * zoom)
        context.line_to(xo + 0.26 * zoom, yo + 0.1 * zoom)
        context.line_to(xo + 0.26 * zoom, yo - 0.1 * zoom)
        context.line_to(xo - 0.26 * zoom, yo - 0.1 * zoom)
        context.line_to(xo - 0.26 * zoom, yo + 0.1 * zoom)
        context.fill()
    ...
    def draw(self, context):
        ...
        for vex, infra in self.saver.infra.items():
            for i, item in enumerate(infra):
                ...
                elif item["type"] == "tech": self.draw_infra_tech(context, vex, i, **item)
